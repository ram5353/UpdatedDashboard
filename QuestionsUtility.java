...
//					}
	...
	public int submitResponse(int student_id,int exam_id) {
		for(Object[] l: list) {
		...
		try{
	        ...
	        Exams exam =(Exams) session.load(Exams.class,exam_id);
	        Results result=new Results();
	        Query query1=session.createQuery("from Results as r");  
